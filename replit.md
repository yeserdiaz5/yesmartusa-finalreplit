...
- **Amazon-Style Header**: Complete Amazon.com-inspired header redesign with dark background (#131921), integrated search system including category dropdown ("All" selector), microphone icon for voice search, yellow search button (#febd69), and blue image search button (#146eb4). Layout: Logo | Deliver to | Category Selector | Search Input | Mic Icon | Search Button | Image Button | Language | Cart | User Menu. Fully responsive with state synchronization between header and content.
