          ...
          {hasLabel ? (
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
              <div className="flex items-center gap-2 mb-3">
                ...
                <h3 className="font-semibold text-blue-900">¡Tu pedido está en camino! 📦</h3>
              </div>
        ...
        {!Array.isArray(orders) || orders.length === 0 ? (
          <Card>
            <CardContent className="p-12 text-center">
              ...
              <h2 className="text-xl font-semibold mb-2">No has realizado compras todavía</h2>
              <p className="text-gray-600 mb-4">Tus compras aparecerán aquí una vez que completes un pedido</p>
